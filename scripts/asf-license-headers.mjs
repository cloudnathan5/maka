...
export const exclusionRules = [
  ...
  },
  {
    ...
    matches: isOneOf(
      ...
      'apps/desktop/resources/licenses/git/LICENSE.txt',
  ...
  {
    id: 'maka-authored-legal-notices',
    justification:
      'Legal notices Maka publishes about a bundled third-party runtime: the attribution notice for the packaged Git distribution and the written offer of source that accompanies it. They are notice text addressed to the recipient of a binary rather than source, and ASF policy leaves notice files unheadered.',
    matches: isOneOf(
      'apps/desktop/resources/licenses/git/NOTICE.txt',
      'apps/desktop/resources/licenses/git/SOURCE_OFFER.txt',
    ),
  },
  {
