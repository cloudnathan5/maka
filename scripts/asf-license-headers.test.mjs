...
describe('ASF header classification', () => {
  ...
  test('excludes the reviewed categories', () => {
    const excluded = {
      ...
      'apps/desktop/resources/licenses/git/LICENSE.txt': 'third-party-license-texts',
      'apps/desktop/resources/licenses/git/NOTICE.txt': 'maka-authored-legal-notices',
      'apps/desktop/resources/licenses/git/SOURCE_OFFER.txt': 'maka-authored-legal-notices',
