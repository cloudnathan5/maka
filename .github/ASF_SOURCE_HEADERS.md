...
| `maka-authored-legal-notices` | Notices Maka publishes about a bundled third-party runtime, addressed to the recipient of a binary rather than to a reader of source. |
